...
const GLOBAL_SCHEDULE = [
  ...
  // (CRM enrich cron retiré : crm_prospects.business_type n'existe pas → l'inférence
  //  se fait en read-time côté Jade/qualification. Réactiver si la colonne est ajoutée.)
