...
export function ShareButtons({ title, slug }: { title: string; slug: string }) {
  ...
  return (
    <div className="flex items-center gap-3 flex-wrap">
      ...
      <button onClick={() => share('linkedin')} className="text-neutral-400 hover:text-blue-700 transition-colors" title="LinkedIn">
      ...
      <button onClick={() => share('facebook')} className="text-neutral-400 hover:text-blue-600 transition-colors" title="Facebook">
