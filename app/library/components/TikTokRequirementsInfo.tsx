  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span>{t.library.triRequirements}</span>
      </button>
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="bg-cyan-50 border border-cyan-200 rounded-lg p-4">
                <h4 className="font-semibold text-cyan-900 mb-2 flex items-center gap-2">
                  ...
                  {t.library.triVideoFormatTitle}
                </h4>
                <ul className="space-y-1 text-cyan-900">
                  <li className="flex items-start gap-2">
                    <span className="text-green-600 font-bold">✓</span>
                    <span>{t.library.triContainerRec}</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-600 font-bold">✓</span>
                    <span>{t.library.triVideoCodec}</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-600 font-bold">✓</span>
                    <span>{t.library.triAudioCodec}</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-600 font-bold">✗</span>
                    <span>{t.library.triNotSupported}</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                <h4 className="font-semibold text-purple-900 mb-2 flex items-center gap-2">
                  ...
                  {t.library.triTechSpecs}
                </h4>
                <ul className="space-y-1 text-purple-900">
                  <li><strong>{t.library.triResolution}</strong></li>
                  <li><strong>{t.library.triAspectRatio}</strong></li>
                  <li><strong>{t.library.triMinDuration}</strong></li>
                  <li><strong>{t.library.triMaxSize}</strong></li>
                  <li><strong>{t.library.triFramerate}</strong></li>
                </ul>
              </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <h4 className="font-semibold text-red-900 mb-2 flex items-center gap-2">
                  ...
                  {t.library.triRestrictions}
                </h4>
                <ul className="space-y-1 text-red-900">
                  <li className="flex items-start gap-2">
                    <span>❌</span>
                    <span>{t.library.triNoWatermark}</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span>❌</span>
                    <span>{t.library.triNoDuplicate}</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span>✅</span>
                    <span>{t.library.triAudioRequired}</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-neutral-50 border border-neutral-200 rounded-lg p-4">
                <h4 className="font-semibold text-neutral-900 mb-2 flex items-center gap-2">
                  ...
                  {t.library.triFfmpegConversion}
                </h4>
                <p className="text-neutral-600 mb-2">{t.library.triFfmpegDesc}</p>
