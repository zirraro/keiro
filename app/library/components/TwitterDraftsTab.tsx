          ...
          <div key={draft.id} className="bg-white rounded-xl border border-neutral-200 overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-4">
              ...
              <div className="flex gap-2">
                <button onClick={() => onEdit(draft)} className="flex-1 px-3 py-2 rounded-lg bg-gradient-to-r from-neutral-800 to-black text-white text-sm font-semibold hover:from-neutral-900 hover:to-neutral-800 transition-all flex items-center justify-center gap-2">
