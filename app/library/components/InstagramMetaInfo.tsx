...
export default function InstagramMetaInfo({ onLearnMore }: InstagramMetaInfoProps) {
  ...
  return (
    <div className="mb-6 bg-gradient-to-r from-[#0c1a3a]/5 to-purple-50 rounded-xl border border-[#0c1a3a]/10 p-4 shadow-sm hover:shadow-md transition-shadow">
      <div className="flex items-start gap-3">
        <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-[#0c1a3a]/50 to-purple-500 flex items-center justify-center shadow-md">
        ...
        <div className="flex-1">
          ...
          <div className="space-y-1.5 mb-3">
            <div className="flex items-center gap-2 text-xs">
              <div className="w-1.5 h-1.5 rounded-full bg-[#0c1a3a] flex-shrink-0"></div>
          ...
          {onLearnMore && (
            <button
              onClick={onLearnMore}
              className="inline-flex items-center gap-2 text-xs font-semibold text-[#0c1a3a] hover:text-[#0c1a3a] transition-colors group"
            >
