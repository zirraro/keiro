...
export default function CreationCard({
  ...
  return (
    <div className="bg-white rounded-xl border border-neutral-200 overflow-hidden group hover:shadow-lg transition-shadow">
      <div className={`relative aspect-video bg-neutral-100 dark:bg-neutral-800 overflow-hidden${item.type === 'image' ? ' cursor-pointer' : ''}`} onClick={item.type === 'image' ? () => setShowPreview(true) : undefined}>
        {/* Placeholder propre (au lieu d'une vignette NOIRE) quand l'image manque
      ...
      <div className="p-4 space-y-2">
        ...
        {/* Single-line icon-only action row — identical to MyVideosTab + ImageCard. */}
