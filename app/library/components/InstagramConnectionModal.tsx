      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full" onClick={(e) => e.stopPropagation()}>
        <div className="relative bg-gradient-to-br from-purple-600 via-pink-500 to-purple-700 px-5 py-5 text-white rounded-t-2xl">
          ...
          <div className="relative flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold">{t.library.icmConnTitle}</h2>
        ...
        <div className="px-5 py-4 space-y-3">
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-3 border border-purple-200">
            <h3 className="text-sm font-semibold text-neutral-900 mb-2">{t.library.connWhyConnect} Instagram ?</h3>
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            >
              <svg className="w-4 h-4 text-[#0c1a3a] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
