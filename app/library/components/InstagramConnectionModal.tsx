      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="px-5 py-4 space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 p-3 rounded-lg bg-gradient-to-r from-purple-600 to-pink-500 text-white font-semibold hover:shadow-lg transition-all text-sm"
          >
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="flex items-center gap-2 p-3 rounded-lg border border-neutral-200 hover:bg-neutral-50 transition-all text-left"
            >
              <svg className="w-4 h-4 text-blue-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              <div>
                <div className="font-semibold text-neutral-900 text-xs">Configurer moi-meme</div>
                <div className="text-[10px] text-neutral-500">Guide Meta</div>
              </div>
            </button>
            <button
            ...
            >
              ...
              <div>
                <div className="font-semibold text-neutral-900 text-xs">Se faire accompagner</div>
                <div className="text-[10px] text-neutral-500">Appel gratuit 30 min</div>
              </div>
            </button>
          </div>

          <p className="text-[10px] text-center text-neutral-500">
            Sans configuration Meta, vous pouvez toujours preparer vos posts et les publier manuellement.
          </p>
        </div>
      </div>
    </div>
