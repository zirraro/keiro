            ...
            return (
              ...
              >
                ...
                <img
                  ...
                  className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-300 z-10 opacity-100"
                  loading="lazy"
                  style={{ display: 'block' }}
                  onLoad={(e) => {
                    console.log(`[InstagramWidget] ✅ Image VISIBLE for post ${post.id}`);
                    // Forcer l'affichage
                    (e.target as HTMLImageElement).style.opacity = '1';
                    (e.target as HTMLImageElement).style.display = 'block';
                  }}
                  onError={(e) => {
                    console.error(`[InstagramWidget] ❌ Image FAILED for post ${post.id}:`, imageUrl);
