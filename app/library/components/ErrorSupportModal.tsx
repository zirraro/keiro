    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl max-w-lg w-full shadow-2xl">
        ...
        <div className="p-6">
          ...
          {technicalError && (
            <details className="mb-4 text-xs">
              ...
              <button
                ...
                className="mt-2 text-xs text-[#0c1a3a] hover:text-[#0c1a3a] font-medium"
              >
          ...
          {/* Support section */}
          <div className="bg-gradient-to-br from-purple-50 to-[#0c1a3a]/5 rounded-lg p-4 border border-purple-200">
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full px-4 py-2 bg-gradient-to-r from-[#0c1a3a] to-[#1e3a5f] text-white rounded-lg font-semibold hover:shadow-lg transition-all text-sm flex items-center justify-center gap-2"
              >
