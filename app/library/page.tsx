...
const TikTokWidget = dynamic(() => import('./components/TikTokWidget'), { ssr: false });
...
const LinkedInWidget = dynamic(() => import('./components/LinkedInWidget'), { ssr: false });
...
const MyVideosTab = dynamic(() => import('./components/MyVideosTab'), { ssr: false });
