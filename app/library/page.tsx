        ...
        {!user && !isGuest && (
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              {/* Studio TikTok */}
              <div className="bg-gradient-to-br from-cyan-50 via-blue-50 to-purple-50 rounded-xl border border-cyan-200 p-5 flex flex-col transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                <div className="flex items-center gap-2 mb-3">
              ...
              {/* Studio LinkedIn */}
              <div className="bg-gradient-to-br from-blue-50 to-sky-50 rounded-xl border border-blue-200 p-5 flex flex-col transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                <div className="flex items-center gap-2 mb-3">
