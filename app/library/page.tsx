...
const CalendarTab = dynamic(() => import('./components/CalendarTab'), { ssr: false, loading: () => <LoadingSkeleton /> });
...
const InstagramWidget = dynamic(() => import('./components/InstagramWidget'), { ssr: false, loading: () => <LoadingSkeleton /> });
const TikTokWidget = dynamic(() => import('./components/TikTokWidget'), { ssr: false, loading: () => <LoadingSkeleton /> });
...
const LinkedInWidget = dynamic(() => import('./components/LinkedInWidget'), { ssr: false, loading: () => <LoadingSkeleton /> });
...
const MyVideosTab = dynamic(() => import('./components/MyVideosTab'), { ssr: false, loading: () => <LoadingSkeleton /> });
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        {!user && !isGuest && (
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {/* Studio Instagram */}
              <div className="bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 rounded-xl border border-pink-200 p-5 flex flex-col transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
              ...
              {/* Studio TikTok */}
              <div className="bg-gradient-to-br from-cyan-50 via-[#0c1a3a]/5 to-purple-50 rounded-xl border border-cyan-200 p-5 flex flex-col transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                <div className="flex items-center gap-2 mb-3">
                  <div className="w-10 h-10 bg-gradient-to-br from-cyan-500 to-[#1e3a5f] rounded-lg flex items-center justify-center">
                    <span className="text-lg">🎵</span>
                  </div>
                  <div>
                ...
                <button onClick={handleStartFree} className="mt-auto w-full px-3 py-2 text-sm bg-gradient-to-r from-cyan-500 to-[#1e3a5f] text-white font-semibold rounded-lg hover:shadow-lg transition-all">
                  {t.library.tryForFree}
                </button>
              </div>

              {/* Studio LinkedIn */}
              <div className="bg-gradient-to-br from-[#0c1a3a]/5 to-[#0c1a3a]/5 rounded-xl border border-[#0c1a3a]/10 p-5 flex flex-col transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                <div className="flex items-center gap-2 mb-3">
                  <div className="w-10 h-10 bg-gradient-to-br from-[#0077B5] to-[#0c1a3a] rounded-lg flex items-center justify-center">
                ...
                <button onClick={handleStartFree} className="mt-auto w-full px-3 py-2 text-sm bg-gradient-to-r from-[#0077B5] to-[#0c1a3a] text-white font-semibold rounded-lg hover:shadow-lg transition-all">
                  {t.library.tryForFree}
                </button>
              </div>

              {/* Studio Twitter/X */}
              <div className="bg-gradient-to-br from-neutral-50 to-neutral-100 rounded-xl border border-neutral-200 p-5 flex flex-col transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                <div className="flex items-center gap-2 mb-3">
        ...
        {user && images.length > 3 && (
          <div className="mb-4 bg-gradient-to-r from-[#0c1a3a]/5 via-indigo-50 to-purple-50 border border-[#0c1a3a]/10 rounded-xl p-4 flex items-start gap-3">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#0c1a3a]/50 to-indigo-500 flex items-center justify-center flex-shrink-0 mt-0.5">
        ...
        {user && credits.plan === 'free' && (
          <div className="mb-4 bg-gradient-to-r from-purple-50 to-[#0c1a3a]/5 border border-purple-200 rounded-xl p-4 flex flex-col sm:flex-row items-center gap-3">
