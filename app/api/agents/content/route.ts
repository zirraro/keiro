...
- PAS DE MÉTAPHORE D'OBJET. Mesuré le 19 août sur les notes basses du contrôle : la moitié des refus venaient d'images métaphoriques — un papier froissé pour « l'occasion ratée », un carré de papier pour « la page blanche », une image jugée « poétique mais abstraite ». Ces visuels passent la règle « une scène, pas un concept » (un papier froissé EST une scène réelle) tout en ne montrant rien du métier. Le lecteur voit un objet, doit deviner le lien, et scrolle.
  La scène montre le MÉTIER DU CLIENT en train de se faire : ses mains, ses produits, son lieu, ses clients. Si on peut remplacer le commerce par n'importe quel autre sans changer l'image, c'est une métaphore — refais-la avec ce que ce commerce a de particulier.
