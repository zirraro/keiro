              ...
              if (post.platform === 'tiktok' && ownerId && dvrRng < 0.35) {
                try {
                  ...
                  if (pair) {
                    ...
                    const GLOBAL = 'ABSOLUTE RULE 1: ZERO text in the video — no captions, titles, labels, overlays, signage with words, watermark. Not a single letter. ABSOLUTE RULE 2: SINGLE continuous shot — no cuts, no jump cuts, no fade-to-black, no transitions. One unbroken take. ABSOLUTE RULE 3: photographer realism — Vogue/Cereal editorial look, no fancy effects, no motion graphics. ';
