  ...
  for (const { prospect, category, dm: rawDm } of dmResults) {
    ...
    if (!dm) {
      ...
      dm = {
        ...
        follow_up_7d: `Dernier message promis haha. Si jamais t'as 5 min pour voir ce que ça donne pour ${name}, y'a un essai gratuit 14 jours — tous les agents IA, carte requise mais 0€ débité 👊`,
        response_interested: `Trop bien ! Regarde, je t'ai fait un truc vite fait. Ça m'a pris 30 sec. Si tu veux tester toi-même y'a un essai gratuit 14 jours, carte requise mais 0€ débité. Tu veux que je t'envoie le lien ?`,
