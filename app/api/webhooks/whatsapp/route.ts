...
async function handleIncomingMessage(
  ...
  try {
    ...
    if (low.includes('prix') || low.includes('combien') || low.includes('tarif')) {
      assistantMessage = "On a 3 plans : Createur a 49\u20AC/mois, Pro a 99\u20AC/mois (le plus populaire) et Business a 149\u20AC/mois (tous les agents). 7 jours d'essai gratuit ! Tu veux les details ?";
