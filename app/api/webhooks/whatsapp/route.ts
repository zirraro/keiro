...
async function handleIncomingMessage(
  ...
  try {
    ...
    if (low.includes('prix') || low.includes('combien') || low.includes('tarif')) {
      assistantMessage = "On a 3 plans : Createur a 49\u20AC/mois (7 agents), Pro a 99\u20AC/mois (10 agents, le plus populaire) et Business a 139\u20AC/mois (15+ agents). 7 jours d'essai gratuit ! Tu veux les details ?";
