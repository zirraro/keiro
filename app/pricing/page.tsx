            ...
            <table className="w-full text-[10px] sm:text-sm min-w-[480px]">
              ...
              <tbody>
                ...
                {(locale === 'fr' ? [
                  ...
                  { name: 'Agents inclus', c: '5', p: '8', b: 'Toute l\u2019\équipe', e: 'Toute l\u2019\équipe', bold: true },
                  ...
                  { name: 'TH\u00c9O Avis Google + fiche \établissement r\épar\ée', c: '\✓', p: '\✓', b: '\✓', e: '\✓' },
                  { name: 'SARA RH & Juridique (contrats pr\êts \à signer)', c: '\✓', p: '\✓', b: '\✓', e: '\✓' },
                  { name: 'LOUIS Finance (business plan, Excel & PowerPoint r\éels)', c: '\✓', p: '\✓', b: '\✓', e: '\✓' },
                  { name: 'HUGO Emails + gestion compl\ète de la bo\îte mail', c: '\—', p: '\✓ (45 emails/j)', b: '\✓ (70 emails/j)', e: '\✓ (90 emails/j)', pro: true },
                  ...
                  { name: 'Included agents', c: '5', p: '8', b: 'Whole team', e: 'Whole team', bold: true },
                  ...
                  { name: 'TH\u00c9O Google reviews + business listing fixed', c: '\✓', p: '\✓', b: '\✓', e: '\✓' },
                  { name: 'SARA HR & Legal (ready-to-sign contracts)', c: '\✓', p: '\✓', b: '\✓', e: '\✓' },
                  { name: 'LOUIS Finance (business plan, real Excel & PowerPoint)', c: '\✓', p: '\✓', b: '\✓', e: '\✓' },
                  { name: 'HUGO Emails + full inbox management', c: '\—', p: '\✓ (45 emails/d)', b: '\✓ (70 emails/d)', e: '\✓ (90 emails/d)', pro: true },
