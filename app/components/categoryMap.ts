...
// Adapter si ton /api/news/search attend d'autres slugs côté serveur
export const BACKEND_CAT: Record<CleanCategory,string|undefined> = {
  actu: undefined,          // flux général (sans filtre serveur)
  politique: 'politique',
  economie: 'business',
  sport: 'sports',
  people: 'people',
...
// Filtre doux par mots-clés quand le backend ne filtre pas
