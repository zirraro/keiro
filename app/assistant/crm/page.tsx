...
function ProspectPanel({ prospect, activities, onClose, onUpdate }: {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex justify-end bg-black/60 backdrop-blur-sm" onClick={onClose}>
      <div className="w-full sm:max-w-2xl lg:max-w-3xl bg-[#0c1a3a] h-full overflow-y-auto animate-in slide-in-from-right duration-200" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }} onClick={e => e.stopPropagation()}>
        {/* Header */}
