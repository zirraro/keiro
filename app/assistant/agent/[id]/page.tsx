...
function getAgentSuggestions(agentId: string, en = false): string[] {
  const s: Record<string, string[]> = en ? {
    marketing: ['Analyze my KPIs', 'Marketing plan this month'],
    commercial: ['Hot prospects to follow up', 'Pipeline conversion rate'],
    email: ['Cold prospect email sequence', 'Open rate'],
    content: ['This week\'s editorial calendar', '5 Instagram post ideas'],
    seo: ['SEO audit of my site', 'Keywords to target'],
    ads: ['Meta Ads campaign', 'Optimize ROAS budget'],
    comptable: ['Cash-flow snapshot', 'Overdue invoices'],
    rh: ['Service agreement', 'GDPR compliance'],
    onboarding: ['Set up my workspace', 'Agents to enable'],
    dm_instagram: ['DM campaign', 'Outreach messages'],
    tiktok_comments: ['Engage community', 'TikTok engagement'],
    gmaps: ['Google Maps listing', 'Reply to customer reviews'],
    chatbot: ['Captured leads', 'Improve auto-replies'],
    whatsapp: ['Message my hot prospects', 'Analyze my WhatsApp conversations'],
  } : {
  ...
  return s[agentId] || (en ? ['What can you do?', 'Analyze performance'] : ['Que peux-tu faire ?', 'Analyse performances']);
}
            ...
            <div className="space-y-4 min-w-0">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-5">
                ...
                <div className="flex flex-wrap gap-2">
                  {getAgentSuggestions(agentId, isEn).map(s => (
