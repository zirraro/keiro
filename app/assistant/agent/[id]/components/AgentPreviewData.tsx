...
export const DEMO_CONTENT_POSTS = [
  { id: 'demo_1', platform: 'instagram', format: 'reel', status: 'draft', hook: 'Les 3 erreurs que font 90% des restaurants sur Instagram', caption: 'Tu postes des photos de plats mais personne ne like ? Voici pourquoi...', scheduled_date: new Date(Date.now() + 86400000).toISOString().slice(0, 10), scheduled_time: '12:00', visual_url: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=200&h=200&fit=crop', video_url: null },
  { id: 'demo_2', platform: 'instagram', format: 'carrousel', status: 'approved', hook: '5 astuces pour doubler ton engagement en 1 semaine', caption: 'Astuce 1: Poste quand tes followers sont actifs...', scheduled_date: new Date(Date.now() + 2 * 86400000).toISOString().slice(0, 10), scheduled_time: '18:00', visual_url: 'https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=200&h=200&fit=crop', video_url: null },
  { id: 'demo_3', platform: 'tiktok', format: 'video', status: 'published', hook: 'Cette technique a fait exploser mon compte en 30 jours', caption: 'Je suis passe de 200 a 5000 followers en utilisant cette strategie...', scheduled_date: new Date(Date.now() - 86400000).toISOString().slice(0, 10), published_at: new Date(Date.now() - 86400000).toISOString(), engagement_data: { likes: 342, comments: 28, shares: 15 }, visual_url: null, video_url: 'demo' },
  { id: 'demo_4', platform: 'instagram', format: 'post', status: 'published', hook: 'Nouveau menu d\'hiver : les clients adorent', caption: 'Notre chef a prepare un menu special pour cet hiver...', scheduled_date: new Date(Date.now() - 2 * 86400000).toISOString().slice(0, 10), published_at: new Date(Date.now() - 2 * 86400000).toISOString(), engagement_data: { likes: 847, comments: 43, shares: 12 }, visual_url: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=200&h=200&fit=crop', video_url: null },
];
