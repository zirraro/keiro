...
export default function PostPreviewModal({ post, onClose, onApprove, onPublish, onSkip }: PostPreviewModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4" onClick={onClose}>
      <div className="bg-gray-900 rounded-2xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-200" onClick={e => e.stopPropagation()}>
        {/* Header */}
        ...
        {/* Visual */}
        <div className={`relative bg-white/5 ${isTT || isStory ? 'aspect-[9/16] max-h-[40vh]' : 'aspect-square max-h-[50vh]'}`}>
          {post.visual_url ? (
