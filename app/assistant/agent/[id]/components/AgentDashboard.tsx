...
/*  (shared primitives: fmt*, KpiCard, SectionTitle, EmptyState,       */
/*   ActionButton, DonutChart, ProgressBar, ActivityFeed,              */
/*   CircularProgress — imported from ./panels/Primitives)             */
/* ------------------------------------------------------------------ */
...
// SeoPanel, AdsPanel, FinancePanel, RhPanel → extracted to panels/*.tsx
...
// ChatbotPanel → extracted to panels/*.tsx
