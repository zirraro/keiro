...
import { SocialConnectBanners, EmailConnectBanner, HotProspectsAlert } from './panels/SharedBanners';
...
// ContentPanel + ContentCalendarInline + ContentDirectionInput + ContentWorkflow → extracted to panels/ContentPanel.tsx
...
// OnboardingPanel + StrategyPresets → extracted to panels/OnboardingPanel.tsx
...
// ─── Agent Notifications — "Reprends la main" banners ────────
function AgentNotifications({ agentId }: { agentId: string }) {
