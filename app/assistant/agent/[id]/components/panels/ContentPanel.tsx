...
// Comptes recommandés à SUIVRE (founder 2026-06-24) — un compte qui suit des
// comptes de sa niche paraît actif. Vrais handles du CRM + recherches (zéro
// handle inventé). TikTok + Instagram. Pour tous les clients.
function FollowSuggestions({ platform, en }: { platform: string; en: boolean }) {
  ...
  if (platform === 'linkedin' || !data) return null;
...
function NetworkPreviewTab({
  ...
  return (
    <div>
      ...
      {/* Comptes recommandés à suivre — signal de compte actif (founder 2026-06-24) */}
      <FollowSuggestions platform={active} en={en} />
