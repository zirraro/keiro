              ...
              <div className="grid sm:grid-cols-2 gap-3 max-w-2xl mx-auto">
                {[
                  ...
                  <button
                    ...
                    className="p-3 bg-gradient-to-br from-[#0c1a3a]/5 to-purple-50 hover:from-[#0c1a3a]/10 hover:to-purple-100 rounded-xl text-left text-xs text-[#0c1a3a] transition-all border border-[#0c1a3a]/10 hover:border-[#0c1a3a]/20 hover:shadow-md"
                  >
                    {example}
                  </button>
                ))}
