    ...
    <main className="min-h-screen p-6 bg-[radial-gradient(1200px_600px_at_50%_-10%,rgba(59,130,246,.14),transparent)] bg-neutral-950 text-neutral-100">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          {/* Colonne droite: résumé & CTA sticky */}
          <div className="lg:col-span-1">
            <div className="lg:sticky lg:top-20 space-y-4">
              ...
              <Card className="p-5">
                <div className="text-sm text-neutral-400">Astuce</div>
                <p className="text-sm mt-2 text-neutral-300">
                  Essayez <em>“Rentrée”</em> ou <em>“Black Friday”</em> pour des visuels qui convertissent fort cette saison.
                </p>
              </Card>
            </div>
          </div>
