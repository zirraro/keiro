  ...
  return (
    <div className="min-h-dvh max-w-2xl mx-auto px-4 py-8 text-white">
      ...
      {sample && (sample.imageUrl || sample.videoUrl) && (
        <div className="mb-5 rounded-2xl overflow-hidden border border-emerald-500/20 bg-gradient-to-br from-emerald-500/[0.06] to-white/[0.02]">
          <div className="p-3 pb-2">
            ...
            <div className="text-xs text-white/45">Du contenu pro comme ça, publié pour toi régulièrement. C'est ça qui t'attend.</div>
          </div>
      ...
      {(confirmed || activated) ? (
        ...
        <p className="text-center text-white/35 text-xs mt-3">+200 commerces font déjà tourner leur présence en ligne avec leur équipe KeiroAI.</p>
      )}
    </div>
  );
}
