        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-lg text-neutral-300">
              ...
              en quelques clics — à partir de votre secteur, de votre angle et des tendances du jour.
            </p>
            ...
            <div className="mt-6 text-xs text-neutral-400">
              Pas de carte requise pour essayer • Export PNG HD • 1 ou 3 variantes au choix
            </div>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-4">
          <Card className="p-5">
            ...
            <p className="mt-2 text-neutral-400 text-sm">
              Choisissez la plateforme, l’objectif et le contexte d’actualité. Keiro prépare le brief pour vous.
            </p>
          </Card>
          <Card className="p-5">
            <div className="text-lg font-semibold">3 variantes instantanées</div>
            <p className="mt-2 text-neutral-400 text-sm">
              Obtenez jusqu’à 3 propositions d’un coup pour aller vite et sélectionner la meilleure.
            </p>
          </Card>
          <Card className="p-5">
            <div className="text-lg font-semibold">Prêt pour les réseaux</div>
            <p className="mt-2 text-neutral-400 text-sm">
              Format auto selon la plateforme (carré, vertical, large). Export en PNG haute qualité.
            </p>
          </Card>
        </div>
      </section>
      ...
      <section id="how-it-works" className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mt-6 grid md:grid-cols-3 gap-4">
          <Card className="p-5">
            ...
            <p className="mt-2 text-neutral-400 text-sm">
              Instagram, TikTok, Facebook, LinkedIn ou X. Keiro choisit le format automatiquement.
            </p>
          </Card>
          <Card className="p-5">
            ...
            <p className="mt-2 text-neutral-400 text-sm">
              Secteur, type de business, tendance du moment, accroche & CTA — on compose un visuel qui capte.
            </p>
          </Card>
          <Card className="p-5">
            ...
            <p className="mt-2 text-neutral-400 text-sm">
              1 ou 3 variantes. Téléchargement en PNG HD. Postez immédiatement sur vos réseaux.
            </p>
          </Card>
        </div>
