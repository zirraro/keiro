              ...
              <table className="w-full text-sm border-collapse min-w-[400px] sm:min-w-[600px]">
                ...
                <tbody>
                  {(locale === 'fr' ? [
                    ...
                    ['Publications/semaine', '2-3 (manuelles)', '5-10', '~18 (auto)'],
                    ['Vidéos', '\u274C Non', '\u274C Non inclus', '\u2705 Reels + TikTok'],
                    ['DMs automatiques', '\u274C Non', '\u274C Non', '\u2705 50/jour'],
                    ['CRM intégré', '\u274C Non', '\u274C Non', '\u2705 Scoring auto (Pro)'],
                    ['Emailing auto', '\u274C Non', '\u274C Non', '\u2705 Séquences 5 étapes (Pro)'],
                    ...
                    ['Integrated CRM', '\u274C No', '\u274C No', '\u2705 Auto scoring (Pro)'],
                    ['Auto emailing', '\u274C No', '\u274C No', '\u2705 5-step sequences (Pro)'],
