          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            ...
            >
              ...
              <ul className="text-[11px] text-neutral-600 space-y-1">
                <li>{'\✓'} 5 agents IA</li>
                <li>{'\✓'} L\éna \· Jade \· L\éo \· Ami \· Clara</li>
                <li>{'\✓'} Contenu + DMs + Prospection + Strat\égie</li>
                <li>{'\✓'} 400 cr\édits/mois</li>
                <li className="text-neutral-300">{'\✗'} Th\éo (avis) & Hugo (emails) \→ Pro</li>
              </ul>
            </button>
