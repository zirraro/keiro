          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            <div className="rounded-2xl border border-neutral-200 shadow-md overflow-hidden">
              <div className="bg-gradient-to-br from-purple-600 to-purple-700 p-6 text-white text-center">
                ...
                <div className="mt-4">
                  <span className="text-lg line-through text-purple-300">89&euro;</span>{' '}
                  <span className="text-4xl font-bold">49&euro;</span>
                  <span className="text-purple-200 ml-1">le 1er mois</span>
                </div>
                <p className="text-sm text-purple-200 mt-1">puis 89&euro;/mois</p>
              </div>
              <div className="p-6">
        ...
        <div className="mx-auto max-w-3xl px-6">
          ...
          <div className="space-y-3">
            ...
            <details className="group rounded-xl border border-neutral-200 bg-white">
              ...
              <div className="px-5 pb-5 text-neutral-600">
                Oui, en 1 clic, sans engagement apr&egrave;s le 1er mois.
              </div>
            </details>
