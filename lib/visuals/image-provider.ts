...
export async function generateImage(opts: ImageGenOptions): Promise<ImageGenResult | null> {
  ...
  ? `${opts.prompt}. The ONLY text visible in the image is the exact phrase "${opts.exactTextInImage}" rendered cleanly in a single readable font, centered or composed naturally. NO other words, gibberish, or random letters anywhere. EDITORIAL PHOTO style, shot on Leica/Hasselblad medium format, natural diffused window light, shallow depth of field f/2.0, real candid moment, slight film grain, true-to-life color palette (no neon, no saturated cyan/magenta), authentic human expressions with depth, real skin texture with pores and slight imperfections — looks like a Vogue/National Geographic shot, NOT a stock illustration. No AI portrait artifacts.`
  : opts.prompt + '. CRITICAL: ZERO text in this image. No words, no letters, no numbers, no captions, no signage with text, no labels, no logos with readable text, no watermarks. The image must be 100% text-free — text will be added later via overlay. EDITORIAL PHOTO style, shot on Leica/Hasselblad medium format, natural diffused window light, shallow depth of field f/2.0, real candid moment, slight film grain, true-to-life color palette (no neon, no saturated cyan/magenta), authentic human expressions with depth, real skin texture with pores and slight imperfections — looks like a Vogue/National Geographic shot, NOT a stock illustration. No AI portrait artifacts.'),
            ...
            negative_prompt: opts.exactTextInImage
              ? 'gibberish text, random letters, fake words, distorted text, multiple text overlays, watermarks, logos, low quality, blurry, deformed faces, extra limbs, plastic skin, porcelain skin, doll-like, mannequin, uncanny valley, dead eyes, glowing eyes, neon glow, hyper-saturated, oversaturated, candy colors, magenta cyan dominant, airbrushed, smooth skin without texture, fake hands, melting fingers, six fingers, symmetrical perfection, stock illustration, AI portrait, midjourney style, cgi render, 3d render look, anime style, cartoon, illustration, vector art'
              : 'text, words, letters, numbers, writing, typography, captions, signs, labels, headlines, slogans, characters, alphabets, watermarks, logos, low quality, blurry, deformed faces, extra limbs, plastic skin, porcelain skin, doll-like, mannequin, uncanny valley, dead eyes, glowing eyes, neon glow, hyper-saturated, oversaturated, candy colors, magenta cyan dominant, airbrushed, smooth skin without texture, fake hands, melting fingers, six fingers, symmetrical perfection, stock illustration, AI portrait, midjourney style, cgi render, 3d render look, anime style, cartoon, illustration, vector art',
            response_format: 'url',
            watermark: false,
            size,
            seed: -1,
