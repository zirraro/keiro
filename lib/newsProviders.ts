...
const CATEGORY_KEYWORDS: { [key: string]: string[] } = {
  ...
  'Tech': ['startup tech', 'tech company', 'silicon valley', 'technologie', 'intelligence artificielle', 'cyber', 'cybersécurité', 'ransomware', 'piratage informatique', 'hacker', 'logiciel', 'software', 'développeur', 'programmeur', 'code informatique', 'application mobile', 'smartphone', 'iphone', 'android', 'google', 'apple', 'microsoft', 'meta', 'facebook', 'amazon', 'netflix', 'tesla tech', 'cloud computing', 'algorithme', 'robot', 'robotique', 'drone', '5g', '6g', 'fibre optique', 'blockchain', 'crypto monnaie', 'bitcoin', 'ethereum', 'nft', 'chatgpt', 'openai', 'deepmind', 'nvidia', 'intel', 'amd', 'github', 'api', 'python', 'javascript', 'react', 'node.js', 'machine learning', 'deep learning', 'neural network', 'data science', 'big data', 'saas', 'paas', 'ia générative', 'llm', 'gpt', 'claude ai', 'gemini', 'copilot', 'innovation technologique', 'innovation numérique', 'transformation digitale', 'industrie 4.0', 'iot', 'objets connectés', 'domotique', 'réalité virtuelle', 'réalité augmentée', 'vr', 'ar', 'metaverse', 'web3', 'linux', 'open source', 'github copilot'],
