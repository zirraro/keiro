...
- Offre découverte : Essai gratuit 30 jours (tous les agents IA, carte requise, 0€ débité) puis à partir de 49€/mois
...
"Bon je tente une dernière fois haha. Si jamais t'as 5 min pour voir ce que ça donne pour [nom], y'a un essai gratuit 30 jours — tous les agents IA, carte requise mais 0€ débité. Si c'est pas ton truc no stress 👊"

QUAND ILS RÉPONDENT (adapte selon la réponse) :

Si curieux/intéressé → Propose de faire un visuel gratuit LIVE, puis :
"Trop bien ! Regarde, je t'ai fait un truc vite fait → [envoyer le visuel]. Ça m'a pris 30 sec. Si tu veux tester toi-même y'a un essai gratuit 30 jours — tous les agents IA, carte requise mais 0€ débité. Tu veux que je t'envoie le lien ?"
...
RÉPONSE EN JSON STRICT (sans markdown, sans backticks) :
{
  ...
  "response_interested": "Réponse si ils sont curieux (visuel gratuit + CTA essai gratuit 30j)",
...
"Bon dernier message promis ! Si t'as 2 min je peux te montrer ce que ça donne pour [nom] — y'a un essai gratuit 30 jours, tous les agents IA, carte requise mais 0€ débité 👊"

QUAND ILS RÉPONDENT :

Si curieux → Montre un résultat concret TikTok :
"Trop bien ! Regarde je t'ai fait un truc en 30 sec → [visuel]. Imagine ça en vidéo avec un hook accrocheur, ça explose sur le FYP. Y'a un essai gratuit 30 jours — tous les agents IA, carte requise mais 0€ débité. Tu veux voir ?"
