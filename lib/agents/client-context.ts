...
export const CLIENT_AGENTS: ClientAgent[] = [
  ...
  // lapage a vendre donc on ne commercialise pas felix".
  {
    id: 'ads',
    displayName: 'Felix',
    title: 'Expert Publicité (retiré)',
    description: 'Ads retiré de l\'offre (founder 25/07 : Félix n\'existe plus).',
  ...
  // in the client UI.
  {
    id: 'seo',
    displayName: 'Theo',
    title: 'SEO & Blog (géré par Théo)',
    description: 'SEO poussé + création de blogs, intégrés à Théo — un seul agent pour toute la présence Google (avis + fiche + SEO + blog). Inclus dès Pro.',
    visibility: 'admin_only',
    minPlan: 'pro',
    gradientFrom: '#f59e0b',
    gradientTo: '#d97706',
  ...
  },
  {
    ...
    displayName: 'Sara',
    title: 'RH & Juridique',
    description: 'Rédige vos contrats, promesses d\'embauche, avenants et attestations, vous conseille sur prud\'hommes, QVT et sorties négociées, et garde vos documents au format de votre marque. Une RH + juriste à vos côtés.',
    visibility: 'active',
    minPlan: 'createur',
    integrations: ['Documents de marque (logo + couleurs)', 'Hub documents KeiroAI'],
    gradientFrom: '#d946ef',
    gradientTo: '#a21caf',
    icon: '\u2696\uFE0F',
  },
  ...
  },
  {
    ...
    description: 'Confirmations de réservation, rappels anti no-show, réponses auto aux questions clients sur WhatsApp. Inclus dès le plan Pro.',
    // Founder 25/07 : WhatsApp inclus dans Pro (99€).
  ...
  },
  {
    ...
    description: 'Business plans, prévisionnels, tableaux Excel et présentations PowerPoint pro — générés et prêts à ta marque. Inclus dès le plan Créateur.',
    visibility: 'active',
    minPlan: 'createur',
    gradientFrom: '#0e7490',
    gradientTo: '#155e75',
