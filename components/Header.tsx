              ...
              {showMenu && (
                <>
                  ...
                  <motion.div
                    ...
                    className={`absolute right-0 mt-2 w-56 max-w-[calc(100vw-16px)] max-h-[80vh] overflow-y-auto overscroll-contain backdrop-blur-xl rounded-xl shadow-2xl py-2 z-20 ${
                    ...
                    {profile.is_admin && (
                      <>
                        <div className={`px-4 py-1.5 text-[10px] font-bold uppercase tracking-wider ${isLight ? 'text-indigo-400' : 'text-indigo-400/60'}`}>
                          {'\u{1F6E1}\uFE0F'} Supervision
                        </div>
                        <Link
                          href="/assistant"
